...
class DescriptionParserFacadeTest extends Specification {
    ...
    def "parses purchase web mobile code"() {
        ...
        where:
        expectedValue    || line
        "sinsay.com" || "2022-10-28,2022-10-27,P³atnoœæ web - kod mobilny,-100.00,PLN,+200.00,Tytu³: 012345,Numer telefonu: +48 123 456 789 ,Lokalizacja: Adres: www.sinsay.com,Operacja: 213456,Numer referencyjny: 135632"
    }
