...
class ExpensesSeparatorTest {
    ...
    private static Stream<Arguments> getTestDataWithTwoLines() {
        String text = " 15.02.2021 12345 P£ATNOŚĆ WEB - KOD MOBILNY-15,853 508,69\n" +
                "14.02.2021 Tel.:48123456789 Godz.19:20:08 Lokalizacja: furgonetka.pl Nr ref: 12345\n" +
                "25.02.2021 12345 P£ATNOŚĆ WEB - KOD MOBILNY-77,392 812,37\n" +
                "24.02.2021 Tel.:48123456789 Godz.22:09:37 Lokalizacja: allegro.pl Nr ref: 12345\n" +
                "08.03.2021 12345 PRZELEW WYCHODZ¥CY-580,00849,32\n" +
    ...
    private static Stream<Arguments> getTestDataWithThreeLines() {
        String text = "18.02.2021 12345 PRZELEW WYCHODZ¥CY-371,373 137,32\n" +
                "18.02.2021 CHIPSY I INNE   72 1020 3583 0000 3902 0140 2932   KATARZYNA TESTOWA WS.\n" +
                "POMORSKA 11 11-111 NOWE P£OTOWO\n" +
                "22.02.2021 12345 PRZELEW PRZYCHODZ¥CY24,992 923,00\n" +
                "22.02.2021 12345   12345   EURO NET Sp. z o.o. UL.\n" +
                "MUSZKIETERÓW 15 02-273 WARSZAWA   Data dokumentu: 22.02.2021\n" +
                "01.03.2021 12345 PRZELEW WYCHODZ¥CY-972,161 700,08\n" +
                "01.03.2021 ZA MIESZKANIE NA P£AZIEJ DZIELNICY   12345\n" +
                "KLAUDIA TESTOWA UL.POMORSKA 1A 11-111 MOKRY B¥K\n";
    ...
    private static Stream<Arguments> getTestDataWithFourLines() {
        String text = "11.02.2021 12345 PRZELEW PRZYCH. SYSTEMAT. WP£YW13 193,794 524,54\n" +
                ...
                "INWESTYCYJNYCH S.A. UL. CH£ODNA 52, 00-872 WARSZAWA   Ref. wł. zlec.: 12345\n" +
