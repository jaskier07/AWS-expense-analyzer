...
class OperationTypeParserInLineTest {
    ...
    static Stream<Arguments> getLineWithSingleOperationType() {
        return Stream.of(
                ...
                Arguments.of("22.02.2021 1231231434234 PRZELEW PRZYCHODZĄCY24,992 923,00", OperationType.INCOMING_TRANSFER),
                Arguments.of("01.03.2021 1231231434234 PRZELEW WYCHODZĄCY-972,161 700,08", OperationType.OUTGOING_TRANSFER),
                Arguments.of("01.03.2021 1231231434234 PŁATNOŚĆ WEB - KOD MOBILNY-177,101 522,98", OperationType.PURCHASE_WEB_MOBILE_CODE),
                Arguments.of("11.02.2021 1231231434234 PRZELEW PRZYCH. SYSTEMAT. WPŁYW3 193,794 524,54", OperationType.OTHER),
